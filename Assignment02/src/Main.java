...
public class Main {
	public static <Strings, strings> void main(String[] args) throws IOException, InvalidInput, WrongPassword,
		...
		int counter = 0;
		try {
			File myObj = new File("D:\\Assignment2\\Assignment02\\src\\flights.txt");
		...
		try {
			File myObj = new File("D:\\Assignment2\\Assignment02\\src\\Ticket.txt");
			Scanner myReader = new Scanner(myObj);
		...
		while (true) {
				...
				while (pass == sysPass && ex == false) {
					...
					if (opt1 == 1) {
						...
						try {
							...
							Files.write(Paths.get("D:\\Assignment2\\Assignment02\\src\\Admin.txt"), "\r\n".getBytes(),
					...
					if (opt1 == 2) {
						...
						int counter2 = 1;
						try {
							File myObj = new File("D:\\Assignment2\\Assignment02\\src\\Customer.txt");
							Scanner myReader = new Scanner(myObj);
							while (myReader.hasNextLine()) {
					...
					if (opt1 == 3) {
						...
						try {
							Files.write(Paths.get("D:\\Assignment2\\Assignment02\\src\\flights.txt"), "\r\n".getBytes(),
									StandardOpenOption.APPEND);
							Files.write(Paths.get("D:\\Assignment2\\Assignment02\\src\\flights.txt"),
					...
					if (opt1 == 4) {
						...
						try {
							...
							PrintWriter writer = new PrintWriter("D:\\Assignment2\\Assignment02\\src\\Ticket.txt");
							writer.print("");
							writer.close();
			...
			if (option == 2) {
				...
				try {
					File myObj = new File("D:\\Assignment2\\Assignment02\\src\\logs.txt");
					Scanner myReader = new Scanner(myObj);
				...
				while (next == true) {
					...
					if (choice == 1) {
						...
						try {
							Files.write(Paths.get("D:\\Assignment2\\Assignment02\\src\\Customer.txt"),
									"\r\n".getBytes(), StandardOpenOption.APPEND);
							Files.write(Paths.get("D:\\Assignment2\\Assignment02\\src\\Customer.txt"),
			...
			if (option == 3) {
				...
				try {
					Files.write(Paths.get("D:\\Assignment2\\Assignment02\\src\\logs.txt"), "\r\n".getBytes(),
							StandardOpenOption.APPEND);
					Files.write(Paths.get("D:\\Assignment2\\Assignment02\\src\\logs.txt"),
